...
class GUI(UI):
    ...
    def mouse_check(self):
        ...
        if pygame.mouse.get_pressed()[0]:
            ...
            self.life.curr_generation[right_number][left_number] = int(
                not bool(self.life.curr_generation[right_number][left_number])
            )
...
if len(sys.argv) <= 1:
    ...
    for j in range(1, len(sys.argv), 2):
        ...
        if i == "--help":
            ...
            print(
                "\nНеверный ключ командной строки: ",
                i,
                "\n" "Вызовите программу с аргументом --help для помощи.\n",
            )
            exit(1)
